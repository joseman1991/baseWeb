    ...
    public String obteLista() {
        try {
            ...
            while (dc_Consumo_datos.next()) {
                ...
                dc_consumo_r.setPlaca(dc_Consumo_datos.getString(1));
                dc_consumo_r.setCostro(dc_Consumo_datos.getString(2));
                dc_consumo_r.setNombres(dc_Consumo_datos.getString(3));
                dc_consumo_r.setSexo(dc_Consumo_datos.getString(4));
                dc_consumo_r.setFechainicio(dc_Consumo_datos.getString(5));
                dc_consumo_r.setFechafin(dc_Consumo_datos.getString(6));
